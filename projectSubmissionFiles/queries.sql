-- Query outputs images are in the queries_output folder

-- Query #1 Contain a join of at least three tables
...
-- Query #4 One must contain a complex search criterion (more than one expression with logical connectors). Experiment with advanced query mechanisms such as RCTE, PARTITION BY, or SELECT CASE/WHEN
...
-- Query #5 Shows the number of users in each skill at each proficiency level
